# Skill: Correção de Bug — trabalho do DEV (universal)
...
1. **Pega o card** — lê o bug (`03 Trabalho/QA/<projeto>/Demandas/Bugs/<PROJ>-NNN`, template `Templates/Bug/01 - Bug`): sintoma, causa provável, CTs, ambiente.
