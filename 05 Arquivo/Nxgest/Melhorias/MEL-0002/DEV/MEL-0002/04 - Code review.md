...
**Estado:** ✅ aprovado para validação funcional

## Checklist

- [x] Diff limitado ao PLAN-088.
- [x] CPF e clientes existentes permanecem compatíveis.
- [x] Testes e gates aplicáveis estão verdes.
- [x] CTs principais do pacote QA estão cobertos.
- [x] Documentação foi sincronizada.
- [x] Nenhum segredo ou dependência desnecessária foi introduzido.
