...
- Bug: [[05 Arquivo/Nxgest/Bugs/NXG-026/QA/01 - Bug|01 - Bug]]
- Casos de teste: [[05 Arquivo/Nxgest/Bugs/NXG-026/QA/02 - Casos de teste|02 - Casos de teste]]
- Validação: [[05 Arquivo/Nxgest/Bugs/NXG-026/QA/03 - Validação|03 - Validação]]
- Análise: [[05 Arquivo/Nxgest/Bugs/NXG-026/DEV/01 - Análise|01 - Análise]]
- Plano: [[05 Arquivo/Nxgest/Bugs/NXG-026/DEV/02 - Plano de execução|02 - Plano de execução]]
- Implementação: [[05 Arquivo/Nxgest/Bugs/NXG-026/DEV/03 - Implementação|03 - Implementação]]
- Review: [[05 Arquivo/Nxgest/Bugs/NXG-026/DEV/04 - Code review|04 - Code review]]
...
- 29/08 — **Commit `8454392` local** (push/deploy pendentes por decisão do dono) + fechamento (card+fix → `05 Arquivo/Nxgest/Bugs/NXG-026/`).
