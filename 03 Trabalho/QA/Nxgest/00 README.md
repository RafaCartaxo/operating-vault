...
- **Validação aprovada:** atualiza os artefatos para concluído e move o pacote completo para `05 Arquivo/<projeto>/<ID>/`.

Cada demanda possui uma pasta própria e um `00 README.md` que resume o status e concentra os links daquela entrega. Os arquivos `01–03` preparam o trabalho; `04 - Validação dev` só é executado após o retorno do DEV. O trabalho técnico de implementação fica em `03 Trabalho/DEV/Nxgest`.
