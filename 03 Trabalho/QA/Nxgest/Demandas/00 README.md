...
Quando o bug for corrigido, a validação pode ser acrescentada como `03 - Validação <ambiente>.md`, e o fix correspondente fica em `03 Trabalho/DEV/Nxgest/Fixes/`.
