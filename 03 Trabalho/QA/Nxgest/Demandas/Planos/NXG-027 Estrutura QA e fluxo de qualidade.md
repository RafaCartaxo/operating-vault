...
- 03 Trabalho/QA/Nxgest representa preparação, triagem, refinamento, planejamento e validação de qualidade.
- 03 Trabalho/DEV/Nxgest representa implementação, dividido em Fixes (bugs) e Execuções (melhorias).
...
- [x] Atualizar README e índices para 03 Trabalho/QA/Nxgest e 03 Trabalho/DEV/Nxgest.
...
- [ ] C1. Existe uma única área numerada 03 Trabalho/QA/Nxgest para preparação e qualidade.
- [ ] C2. Existe uma única área numerada 03 Trabalho/DEV/Nxgest, com Fixes e Execuções separados.
...
**Então** o agente permite abrir 03 Trabalho/DEV/Nxgest/Execuções/<ID> com PLAN vinculado
...
**Então** card e pasta vão juntos para 05 Arquivo/<projeto>/<ID>, preservando os links
